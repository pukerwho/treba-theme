<div class="bg-blue-50 dark:bg-zinc-800 rounded-lg px-4 py-3">
  ...
  <div class="mb-2">
    <a href="<?php the_permalink(); ?>" class="font-medium border-b-4 border-indigo-300 dark:border-indigo-400"><?php _e("Детальніше", "treba-wp"); ?></a>
  </div>
</div>