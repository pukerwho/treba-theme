...
function crunchify_social_sharing_buttons($content) {
  ...
  if(is_singular()){
    ...
    $content .= '<li class="flex items-center justify-center bg-indigo-400 hover:bg-indigo-500 rounded mx-1"><a class="share-link share-facebook p-2" href="'.$facebookURL.'" target="_blank"><svg enable-background="new 0 0 24 24" viewBox="0 0 24 24" class="h-4 lg:h-6 w-4 lg:w-6" fill="#ffffff" xmlns="http://www.w3.org/2000/svg"><path d="m15.997 3.985h2.191v-3.816c-.378-.052-1.678-.169-3.192-.169-3.159 0-5.323 1.987-5.323 5.639v3.361h-3.486v4.266h3.486v10.734h4.274v-10.733h3.345l.531-4.266h-3.877v-2.939c.001-1.233.333-2.077 2.051-2.077z"/></svg></a></li>';

    $content .= '<li class="flex items-center justify-center bg-indigo-400 hover:bg-indigo-500 rounded mx-1"><a class="share-link share-twitter p-2" href="'.$twitterURL.'" target="_blank"><svg id="Bold" enable-background="new 0 0 24 24" height="15" viewBox="0 0 24 24" class="h-4 lg:h-6 w-4 lg:w-6" fill="#ffffff" xmlns="http://www.w3.org/2000/svg"><path d="m21.534 7.113c.976-.693 1.797-1.558 2.466-2.554v-.001c-.893.391-1.843.651-2.835.777 1.02-.609 1.799-1.566 2.165-2.719-.951.567-2.001.967-3.12 1.191-.903-.962-2.19-1.557-3.594-1.557-2.724 0-4.917 2.211-4.917 4.921 0 .39.033.765.114 1.122-4.09-.2-7.71-2.16-10.142-5.147-.424.737-.674 1.58-.674 2.487 0 1.704.877 3.214 2.186 4.089-.791-.015-1.566-.245-2.223-.606v.054c0 2.391 1.705 4.377 3.942 4.835-.401.11-.837.162-1.29.162-.315 0-.633-.018-.931-.084.637 1.948 2.447 3.381 4.597 3.428-1.674 1.309-3.8 2.098-6.101 2.098-.403 0-.79-.018-1.177-.067 2.18 1.405 4.762 2.208 7.548 2.208 8.683 0 14.342-7.244 13.986-14.637z"/></svg></a></li>';
